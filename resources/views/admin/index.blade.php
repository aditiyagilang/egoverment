                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            Data Admin</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlahUserPerJabatan['admin'] ?? 0 }}</div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Data Sekretaris</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlahUserPerJabatan['Sekretaris'] ?? 0 }}</div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-info shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Kaur Umum
                                        </div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlahUserPerJabatan['Kaur Umum'] ?? 0 }}</div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        Lainya</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jumlahUserLainnya ?? 0 }}</div>
                                    </div>
                                    <div class="col-auto">
