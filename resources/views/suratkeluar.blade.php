...
<body>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <aside class="left-sidebar">
            @php
                $activePage = 'suratkeluar'; // Contoh, sesuaikan dengan halaman yang sedang aktif
            @endphp
                                ...
                                <div id="table" class="table-editable">
                                    <span class="table-add float-end mb-3 me-2">
                                        <button class="btn btn-sm btn-success" data-toggle="modal"
                                            data-target="#exampleModalCenter5"><i class="ri-add-fill"><span
                                                    ...
                                                    <div class="modal-body">
                                                        <form>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" id="comment" rows="3" placeholder="Contoh textarea .."></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="kategori">
                                                                    ...
                                                                    <!-- Tambahkan opsi dropdown sesuai kebutuhan Anda -->
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="notelp"
                                                                    placeholder="Contoh form text ...">
                                                            </div>
                                                            <div class="form-group">
                                    ...
                                    <table class="table table-bordered table-responsive-md table-striped text-center">
                                        ...
                                        <tbody>
                                            <tr class="">
                                                ...
                                                <td contenteditable="true">Lorem ipsum, dolor sit amet consectetur
                                                    adipisicing elit.
                                                    Qui, neque eligendi. Velit suscipit earum necessitatibus aperiam!
                                                    Cumque porro
                                                    repudiandae inventore alias! Dolores distinctio suscipit quia
                                                    doloribus ratione sapiente rem nemo.</td>
                                                <td contenteditable="true">Lorem ipsum dolor sit amet consectetur
                                                    adipisicing elit.
                                                    Error alias maxime a tenetur quis facere consectetur veniam
                                                    quisquam,
                                                    temporibus, rerum similique velit nisi quae dolor odio corporis iste
                                                    sunt ad?</td>
                                                <td contenteditable="true">Jl. Gajah Mada Jember</td>
                                                <td contenteditable="true">Pengajuan</td>
                                                <td contenteditable="true">08123456789</td>
                                                <td> <!-- Kolom Status -->
                                                    <button type="button"
                                                        class="btn btn-primary btn-rounded btn-sm my-0"
                                                        data-toggle="modal"
                                                        data-target="#exampleModalCenter6">Processed</button>
                                                    <!-- Modal -->
                                                                    ...
                                                                    <form>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-control"
                                                                                id="kategori">
                                                                                <option value="1">Undangan
                                                                                </option>
                                                                                <option value="2">Pengajuan
                                                                                </option>
                                                                                <!-- Tambahkan opsi dropdown sesuai kebutuhan Anda -->
                                                                            </select>
                                                                        </div>
